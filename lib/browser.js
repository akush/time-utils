...
BrowserUtils.getInfo = () => {
  const info = {
    ios: false,
    iosWebview: false,
    isFirefox: typeof InstallTrigger !== "undefined",
    androidWebview: false,
    phonepeWebview: false,
    ucBrowser: false,
    mobileCheck: () => true,
  ...
  if (typeof window !== "undefined") {
    ...
    info.phonepeWebview = /phonepe/.test(userAgent);
    info.ucBrowser = /((?:[\s\/])uc?\s?browser|(?:juc.+)ucweb)[\/\s]?([\w\.]+)/i.test(userAgent);
    info.newTabSupported = !(info.androidWebview || info.iosWebview || info.ucBrowser || info.phonepeWebview);
...
exports = module.exports = BrowserUtils;